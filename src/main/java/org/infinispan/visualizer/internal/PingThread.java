...
/**
 * This class attempts to "ping" JDG server in order to retrieve topology information, which in turn triggers an update
 * to HotRod Client's internal server list.  This server list is used for visualization purposes.
 * <p>
 * Currently, there is no public method to invoke a "ping" operation via the RemoteCache interface.  This code currently
 * uses "stats" operation.
 *
